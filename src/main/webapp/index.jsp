...
<div class="container">	
		<div class="row justify-content-center my-auto vh-100">
				...
				<div class="col-md-6 col-lg-8 d-flex justify-content-center  align-items-center" id="parrafo1">
					<p>Somos una empresa especializada en asesorías en prevención
						de riesgos. Nuestro equipo de expertos cuenta con una amplia
						experiencia en el campo de la seguridad laboral y está
						...
						desde la evaluación y gestión de riesgos hasta la capacitación en
						seguridad, para ayudar a nuestros clientes a cumplir con los
						requisitos legales y mejorar continuamente sus prácticas de
						prevención de riesgos. En resumen, estamos comprometidos con el
						éxito de nuestros clientes a través de la prevención de riesgos y
						la promoción de un entorno de trabajo seguro y saludable.</p>
				</div>
		</div>
</div>			
</body>
